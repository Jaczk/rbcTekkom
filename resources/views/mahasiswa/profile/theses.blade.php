...
@section('content')
    <div class="container-xl p-4 mt-4">
        ...
        <hr class="mt-0 mb-4">
        <form enctype="multipart/form-data" method="POST" action="{{ route('user.profile.theses.create', $user->id) }}">
            @csrf
            <div class="row">
                <div class="col-xl-8">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" id="author" type="text" disabled
                                    placeholder="Masukkan nama penulis " name="author" value="{{ $user->name }}">
                                <!-- Hidden input field -->
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" id="year" type="number"
                                    placeholder="Masukkan Tahun Tugas Akhir " name="year" value="{{ old('year') }}">
                            </div>
                            <div class="mb-3">
                                <label class="small mb-1" for="abstract">Abstrak</label>
                                <textarea class="form-control" id="abstract" rows="5" name="abstract" value="{{ old('abstract') }}">
                            </textarea>
                            </div>
                            <div class="mb-3">
...
@section('js')
    ...
    <script>
        function confirmCreateForm(event) {
            ...
            Swal.fire({
                title: 'Upload Tugas Akhir?',
                text: 'Data Tugas Akhir akan dibuat, harap perhatikan bahwa dokumen telah di ttd',
                icon: 'warning',
